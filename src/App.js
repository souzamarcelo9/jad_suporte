      ...
      <div id="produtos">
        <Container>
          ...
          <Row className="customRow">                        
            ...
            <Col><a href="https://www.youtube.com/watch?v=boUf-wtlXMI"><img alt="logistica" src={logistic} style={{ width: 60,height:58}}/><br /> <Text style={{color: 'blue'}}onPress={() => Linking.openURL('https://youtu.be/OMbWfy9thLY ')}>{lang.produtos.text6}</Text></a></Col>
